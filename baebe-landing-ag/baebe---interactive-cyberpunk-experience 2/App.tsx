...
export default function App() {
  ...
  const handleBootComplete = useCallback(() => {
    // Skip 'The Drop' (Cutscene 1) as requested, go straight to capture
...
[ ] Dr. Ayumi - The Creator (Locked)`, 'output', 5);
  ...
  return (
    <>
      ...
      {view === 'EMAIL_CAPTURE' && <EmailCapture onComplete={handleEmailComplete} onSubscribe={handleSubscribe} />}

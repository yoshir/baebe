...
Taivalu achieves quantum coherence with Baebe and Kess during the tower fall. His Ghost Thesis state stabilizes the entire protocol, maintaining the wave function that allows the signal to broadcast. Angel's sacrifice cleared the path for the three to link.
